            ...
            for pmode in [1, 3, 6, 12]:
                for slice in [1, 3, 6]:
                    try:
                        ...
                        vprint(f"Running (round_idx, batch, pmode, slice) = {(round_idx, batch, pmode, slice)}")
                        ...
                        vprint(f"An error occurred for (round, batch, pmode, slice) = {(round_idx, batch, pmode, slice)}: {e}")
