#!/bin/bash
# Run this bash script with `sudo bash ./02_scripts/bash_run_ptyshv_profiling.sh`
# Note that the GPU metrics in nsys requires sudo permission

# === LOCAL RUN: ptyshv profiling script ===

# Set job name and identifiers manually if needed
JOB_NAME="ptyshv_profiling_tBL_WSe2_b1024_p12_6slice"
...
PARAMS_PATH="01_params/ptyshv_profiling_tBL_WSe2_b1024_p12_6slice.json"
